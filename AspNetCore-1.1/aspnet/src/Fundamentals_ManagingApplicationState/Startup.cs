...
using Fundamentals_ManagingApplicationState.Models;
using Newtonsoft.Json;

namespace Fundamentals_ManagingApplicationState
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            // Session is built on top of dist. cache. So this is required
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            // Store values in HttpContext Items property. will last only for a request
            ...
            // this section will exprire early since session was not configured yet.
