...
namespace Massive
{
    public static class ObjectExtensions
    {
        ...
        public static dynamic ToExpando(this object o)
        {
            ...
            var d = result as IDictionary<string, object>; //work with the Expando as a Dictionary
            if (o.GetType() == typeof(ExpandoObject)) return o; //shouldn't have to... but just in case
            if (o.GetType() == typeof(IEnumerable<KeyValuePair<string, object>>))// || o.GetType().IsSubclassOf(typeof(NameValueCollection)))
            {
                var items = (IEnumerable<KeyValuePair<string, object>>)o;
    ...
    public static class DbProviderFactories
    {
        public static DbProviderFactory GetFactory(string providerInvariantName)
        {
            ...
            if (string.Equals("System.Data.SqlClient", providerInvariantName, StringComparison.OrdinalIgnoreCase))
            {
                return new SqlClientFactory();
            }
            throw new NotSupportedException(providerInvariantName);
        }
    }
    ...
    public class DynamicModel : DynamicObject
    {
        ...
        public DynamicModel(string connectionString, string tableName = "", string primaryKeyField = "", string descriptorField = "")
        {
        ...
        /// </summary>
        public dynamic CreateFrom(IEnumerable<KeyValuePair<string, object>> coll)
        {
        ...
        public dynamic DefaultValue(dynamic column)
        {
            ...
            {
                result = DateTime.Now.ToString("d");//.ToShortDateString();
            }
            else if (def == "newid()")
            {
