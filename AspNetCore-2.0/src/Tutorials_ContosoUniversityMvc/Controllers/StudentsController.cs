...
using Tutorials_ContosoUniversityMvc.Data;
using Tutorials_ContosoUniversityMvc.Models;

namespace Tutorials_ContosoUniversityMvc.Controllers
{
    public class StudentsController : Controller
    {
        ...
        /// If improving performance in a high-volume application
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> DeleteConfirmed(int id)
        //{
